...
public class CategoriesRepositoryProducerDefaultImpl implements CategoriesRepositoryProducer {

    private final ApplicationContext ctx;

    public CategoriesRepositoryProducerDefaultImpl(ApplicationContext ctx) {
        this.ctx = ctx;
    }
