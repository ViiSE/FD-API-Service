...
public class ProductsRepositoryProcessorsProducerDefaultImpl implements ProductsRepositoryProcessorsProducer {

    private final ApplicationContext ctx;

    public ProductsRepositoryProcessorsProducerDefaultImpl(ApplicationContext ctx) {
        this.ctx = ctx;
    }
