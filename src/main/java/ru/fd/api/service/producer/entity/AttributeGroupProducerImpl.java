...
@Service("attributeGroupProducer")
public class AttributeGroupProducerImpl implements AttributeGroupProducer {

    private final ApplicationContext ctx;

    public AttributeGroupProducerImpl(ApplicationContext ctx) {
        this.ctx = ctx;
    }
