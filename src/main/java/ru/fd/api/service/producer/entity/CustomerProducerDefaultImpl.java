...
@Service("customerProducerDefault")
public class CustomerProducerDefaultImpl implements CustomerProducer {

    private final ApplicationContext ctx;

    public CustomerProducerDefaultImpl(ApplicationContext ctx) {
        this.ctx = ctx;
    }
