...
public class StatusesRepositoryProducerDefaultImpl implements StatusesRepositoryProducer {

    private final ApplicationContext ctx;

    public StatusesRepositoryProducerDefaultImpl(ApplicationContext ctx) {
        this.ctx = ctx;
    }
