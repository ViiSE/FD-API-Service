...
@Service("orderResponseProducer")
public class OrderResponseProducerImpl implements OrderResponseProducer {

    private final ApplicationContext ctx;

    public OrderResponseProducerImpl(ApplicationContext ctx) {
        this.ctx = ctx;
    }
    ...
    public OrderResponse getOrderResponseWithMessageInstance(OrderResponse response, String message) {
        return (OrderResponse) ctx.getBean("orderResponseWithMessage", response, message);
    }
}
