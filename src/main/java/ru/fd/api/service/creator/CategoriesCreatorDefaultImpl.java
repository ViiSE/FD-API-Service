...
public class CategoriesCreatorDefaultImpl implements CategoriesCreator {

    private final CategoriesRepository categoriesRepository;

    public CategoriesCreatorDefaultImpl(CategoriesRepository categoriesRepository) {
    ...
    public Categories create() throws CreatorException {
        try {
            return categoriesRepository.readCategories();
