...
@Service("attributesCreatorDefault")
public class AttributesCreatorDefaultImpl implements AttributesCreator {

    private final AttributesRepository attributesRepository;

    public AttributesCreatorDefaultImpl(AttributesRepository attributesRepository) {
    ...
    public Attributes create() throws CreatorException {
        try {
            return attributesRepository.readAttributes();
