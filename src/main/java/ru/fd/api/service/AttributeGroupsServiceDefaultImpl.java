...
import ru.fd.api.service.producer.repository.AttributeGroupsRepositoryProducer;
...
public class AttributeGroupsServiceDefaultImpl implements AttributeGroupsService {
    ...
    public AttributeGroupProducer attributeGroupProducer() {
        return attributeGroupProducer;
    }

    @Override
    public AttributeGroupsProducer attributeGroupsProducer() {
        return attributeGroupsProducer;
    }

    @Override
    public AttributeGroupsCreatorProducer attributeGroupsCreatorProducer() {
        return attrGrCrProducer;
    }

    @Override
    public AttributeGroupsRepositoryProducer attributeGroupsRepositoryProducer() {
        return attrGrRepoProducer;
    }
}
