...
@Component("psDepartments")
public class PsDepartmentsImpl implements Process<Sendable, Void> {

    private final DepartmentsRepository departmentsRepository;

    public PsDepartmentsImpl(DepartmentsRepository departmentsRepository) {
    ...
    public Sendable answer(Void nothing) throws ProcessException {
        try {
            return departmentsRepository.read();
