...
@Component("psAttributes")
public class PsAttributesImpl implements Process<Sendable, Void> {

    private final AttributesRepository attributesRepository;

    public PsAttributesImpl(AttributesRepository attributesRepository) {
    ...
    public Sendable answer(Void nothing) throws ProcessException {
        try {
            return attributesRepository.read();
