...
@Component("psAttributeGroups")
public class PsAttributeGroupsImpl implements Process<Sendable, Void> {

    private final AttributeGroupsRepository attributeGroupsRepository;

    public PsAttributeGroupsImpl(AttributeGroupsRepository attributeGroupsRepository) {
    ...
    public Sendable answer(Void nothing) throws ProcessException {
        try {
            return attributeGroupsRepository.read();
