...
@Component("psCategories")
public class PsCategoriesImpl implements Process<Sendable, Void> {

    private final CategoriesRepository categoriesRepository;

    public PsCategoriesImpl(CategoriesRepository categoriesRepository) {
    ...
    public Sendable answer(Void nothing) throws ProcessException {
        try {
            return categoriesRepository.read();
