...
import ru.fd.api.service.process.test.PsCategoriesTestImpl;

import static org.testng.Assert.assertNotNull;

public class PsCategoriesTestNG {

    @Test
    public void answer() throws ProcessException, JsonProcessingException {
        Process<Categories, Void> pr = new PsCategoriesTestImpl();
        Sendable categories = pr.answer(null);
        assertNotNull(categories, "Categories is null!");
        String print = new ObjectMapper()
                .writerWithDefaultPrettyPrinter()
                .writeValueAsString(categories.formForSend());
