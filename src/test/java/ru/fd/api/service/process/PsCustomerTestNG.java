...
import ru.fd.api.service.process.test.PsCustomerTestImpl;

import static org.testng.Assert.assertNotNull;

public class PsCustomerTestNG {

    @Test
    public void answer() throws ProcessException, JsonProcessingException {
        Process<Customer, Void> pr = new PsCustomerTestImpl();
        Sendable customer = pr.answer(null);
        assertNotNull(customer, "Customer is null!");
        String print = new ObjectMapper()
                .writerWithDefaultPrettyPrinter()
                .writeValueAsString(customer.formForSend());
