...
import ru.fd.api.service.process.test.PsCountriesTestImpl;

import static org.testng.Assert.assertNotNull;

public class PsCountriesTestNG {

    @Test
    public void answer() throws ProcessException, JsonProcessingException {
        Process<Countries, Void> pr = new PsCountriesTestImpl();
        Sendable countries = pr.answer(null);
        assertNotNull(countries, "Countries is null!");
        String print = new ObjectMapper()
                .writerWithDefaultPrettyPrinter()
                .writeValueAsString(countries.formForSend());
