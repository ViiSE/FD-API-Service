...
import ru.fd.api.service.process.test.PsUnitsTestImpl;

import static org.testng.Assert.assertNotNull;

public class PsUnitsTestNG {

    @Test
    public void answer() throws ProcessException, JsonProcessingException {
        Process<Units, Void> pr = new PsUnitsTestImpl();
        Sendable units = pr.answer(null);
        assertNotNull(units, "Units is null!");
        String print = new ObjectMapper()
                .writerWithDefaultPrettyPrinter()
                .writeValueAsString(units.formForSend());
