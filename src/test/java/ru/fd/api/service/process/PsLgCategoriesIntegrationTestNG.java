...
public class PsLgCategoriesIntegrationTestNG extends AbstractTestNGSpringContextTests {

    @Autowired
    @Qualifier("psLgCategories")
    private Process<Sendable, Void> psLgCats;

    @BeforeClass
    public void setUpClass() {
        writeTestTime(PsLgCategoriesImpl.class);
    }

    @Test
    public void answer() throws JsonProcessingException {
        testBegin(PsLgCategoriesImpl.class, "answer()");

        try {
            Sendable categories = psLgCats.answer(null);
        ...
        testEnd(PsLgCategoriesImpl.class, "answer()");
    }
