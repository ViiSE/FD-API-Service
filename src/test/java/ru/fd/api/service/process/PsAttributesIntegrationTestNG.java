...
public class PsAttributesIntegrationTestNG extends AbstractTestNGSpringContextTests {

    @Autowired
    @Qualifier("psAttributes")
    private Process<Sendable, Void> psAttrs;

    @BeforeClass
    public void setUpClass() {
        writeTestTime(PsAttributesImpl.class);
    }

    @Test
    public void answer() throws JsonProcessingException {
        testBegin(PsAttributesImpl.class, "answer()");

        try {
            Sendable attrGroups = psAttrs.answer(null);
        ...
        testEnd(PsAttributesImpl.class, "answer()");
    }
