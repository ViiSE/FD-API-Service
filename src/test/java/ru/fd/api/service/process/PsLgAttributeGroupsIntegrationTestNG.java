...
public class PsLgAttributeGroupsIntegrationTestNG extends AbstractTestNGSpringContextTests {

    @Autowired
    @Qualifier("psLgAttributeGroups")
    private Process<Sendable, Void> psAttrGroups;

    @BeforeClass
    public void setUpClass() {
        writeTestTime(PsLgAttributeGroupsImpl.class);
    }
    ...
    public void readCategories() throws JsonProcessingException {
        ...
        testEnd(PsLgAttributeGroupsImpl.class, "answer()");
    }
