...
import ru.fd.api.service.repository.test.ProductsRepositoryWithFullDescriptionTestImpl;
...
public class ProductsRepositoryWithFullDescriptionTestNG {
    ...
    public void readProducts() {
        testBegin("ProductRepositoryWithFullDescription", "read()");
        ...
        testEnd("ProductRepositoryWithFullDescription", "read()");
    }
