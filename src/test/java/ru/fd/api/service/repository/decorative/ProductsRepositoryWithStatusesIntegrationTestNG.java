...
public class ProductsRepositoryWithStatusesIntegrationTestNG extends AbstractTestNGSpringContextTests {

    @Autowired
    @Qualifier("productsRepositoryWithStatuses")
    private ProductsRepositoryDecorative<Products> statusesRepo;
    ...
    public void read() throws JsonProcessingException {
        ...
        try {
            Products products = statusesRepo.read(simpleRepo.read());
