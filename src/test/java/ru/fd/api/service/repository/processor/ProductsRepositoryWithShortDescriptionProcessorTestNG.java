...
public class ProductsRepositoryWithShortDescriptionProcessorTestNG {
    ...
    public void setUpClass() {
        ...
        processor = new ProductsRepositoryWithShortDescriptionProcessorImpl(prRepoProducer, productProducer, null);
        prRepoSimple = new ProductsRepositorySimpleTestImpl();
    }

    @Test
    public void apply() {
        testBegin("ProductsRepositoryWithShortDescriptionProcessor", "apply()");

        ProductsRepository prRepo = (ProductsRepository) processor.apply(prRepoSimple);
        assertNotNull(prRepo, "ProductsRepository is null!");
        assertTrue(prRepo instanceof ProductsRepositoryWithShortDescriptionTestImpl,
                "Products repository is not instanceof test short description!");
        System.out.println("ProductsRepository: " + prRepo);

        testEnd("ProductsRepositoryWithShortDescriptionProcessor", "apply()");
    }
