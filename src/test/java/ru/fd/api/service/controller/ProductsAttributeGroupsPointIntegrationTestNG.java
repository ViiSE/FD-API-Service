...
public class ProductsAttributeGroupsPointIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    void whenNotValidToken_thenReturns401WithoutContent(String incorrectToken) throws Exception {
        testMethod("attributeGroups() [when not valid token then returns 401 without content]");
    ...
    void whenNotAuthorizationHeader_thenReturns401WithoutContent() throws Exception {
        testMethod("attributeGroups() [when not auth header then returns 401 without content]");
    ...
    void whenTokenIsNotJWT_thenReturns401WithoutContent(String notJWTToken) throws Exception {
        testMethod("attributeGroups() [when token is not JWT then returns 401 without content]");
