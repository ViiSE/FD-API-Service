...
public class ProductsControllerIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    void whenNotValidToken_thenReturns200WithoutContent(String incorrectToken) throws Exception {
        testMethod("products() [when not valid token then returns 200 without content]");
    ...
    void whenNotAuthorizationHeader_thenReturns200WithoutContent() throws Exception {
        testMethod("products() [when not auth header then returns 200 without content]");
    ...
    void whenTokenIsNotJWT_thenReturns200WithoutContent(String notJWTToken) throws Exception {
        testMethod("products() [when token is not JWT then returns 200 without content]");
