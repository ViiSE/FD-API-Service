...
public class ProductsStatusesPointIntegrationTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void setUpClass(int timeToLive) {
        ...
        testBegin("ProductsAdditionalController [GET /products/statuses]");
        writeTestTime("ProductsAdditionalController [GET /products/statuses]");
    }

    @Test(priority = 1)
    void whenValidToken_thenReturns200WithContent() throws Exception {
        testMethod("statuses() [when valid token then returns 200 with content]");
        ...
        StatusesPojo statusesPojo = (StatusesPojo) statusesService.statusesCreatorProducer()
                .getStatusesCreatorDefaultInstance(
                        statusesService.statusesRepositoryProducer()
                                .getStatusesRepositoryDefaultInstance(
    ...
    public void teardownClass() {
        testEnd("ProductsAdditionalController [GET /products/statuses]\"");
    }
}
